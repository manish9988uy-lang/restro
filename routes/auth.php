...
Route::middleware('auth')->group(function () {
    ...
    Route::post('two-factor/qr', [TwoFactorAuthenticationController::class, 'showQrCode'])
        ->name('two-factor.qr');

    Route::post('two-factor/recovery-codes', [TwoFactorAuthenticationController::class, 'recoveryCodes'])
