...
@section('page-title', 'Edit Notification Campaign')
...
<div class="row justify-content-center">
    <div class="col-lg-8">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('notifications.update', $campaign) }}">
                    @csrf @method('PUT')
                    <div class="row g-3">
                        <div class="col-md-12">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="type" class="form-select @error('type') is-invalid @enderror" required>
                                ...
                                <option value="whatsapp" {{ old('type', $campaign->type) === 'whatsapp' ? 'selected' : '' }}>WhatsApp</option>
                            </select>
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea name="message" rows="5" class="form-control @error('message') is-invalid @enderror" required>{{ old('message', $campaign->message) }}</textarea>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="row g-2 mt-2">
                                ...
                                <div class="col-md-6">
                                    <div class="form-check">
                                        <input type="checkbox" name="customer_ids[]" value="{{ $customer->id }}" class="form-check-input" id="customer_{{ $customer->id }}" {{ in_array($customer->id, old('customer_ids', $campaign->recipients ?? [])) ? 'checked' : '' }}>
