    ...
    <div class="col-xl-8">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <span class="fw-600"><i class="bi bi-pencil me-2 text-info"></i>Edit Delivery</span>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="rider_id" class="form-select">
                                ...
                                @foreach($riders as $rider)
                                    <option value="{{ $rider->id }}" @selected(old('rider_id', $delivery->rider_id) == $rider->id)>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="delivery_fee" id="deliveryFee" step="0.01" min="0" class="form-control" value="{{ old('delivery_fee', $delivery->delivery_fee) }}">
                            </div>
                        </div>
                        <div class="col-12">
                            <label class="form-label small fw-600">Delivery Address <span class="text-danger">*</span></label>
                            <textarea name="delivery_address" class="form-control @error('delivery_address') is-invalid @enderror" rows="3" required>{{ old('delivery_address', $delivery->delivery_address) }}</textarea>
